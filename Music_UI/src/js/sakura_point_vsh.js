...
void main(void) {
    ...
    vec3 col = mix(vec3(51.0/255.0, 181.0/255.0, 229.0/255.0), vec3(71.0/255.0, 201.0/255.0, 249.0/255.0), r);
    float grady = mix(0.0, 1.0, pow(coord.y * 0.5 + 0.5, 0.35));
    //col *= vec3(51.0/255.0, 181.0/255.0, 229.0/255.0);
    //col *= vec3(10.0, 10.0, 10.0);
    //col *= mix(0.8, 1.0, pow(abs(coord.x), 0.3));
    //col = col * diffuse + specular;
    //col = mix(vec3(1.0, 0.8, 0.75), vec3(1.0, 0.9, 0.87), r);
